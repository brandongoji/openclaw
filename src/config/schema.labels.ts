...
export const FIELD_LABELS: Record<string, string> = {
  ...
  models: "AI Models",
  "models.mode": "Models Merge Mode",
  "models.providers": "Model Providers",
  "models.providers.*.baseUrl": "Provider Base URL",
  "models.providers.*.apiKey": "Provider API Key",
  "models.providers.*.auth": "Provider Auth Mode",
  "models.providers.*.api": "Provider API",
  "models.providers.*.headers": "Provider Headers",
  "models.providers.*.authHeader": "Send Authorization Header",
  "models.providers.*.models": "Provider Models",
  "models.providers.*.models[].id": "Model ID",
  "models.providers.*.models[].name": "Model Name",
  "models.providers.*.models[].api": "Model API",
  "models.providers.*.models[].reasoning": "Reasoning Model",
  "models.providers.*.models[].input": "Model Inputs",
  "models.providers.*.models[].contextWindow": "Context Window",
  "models.providers.*.models[].maxTokens": "Max Tokens",
  "models.providers.*.models[].headers": "Model Headers",
