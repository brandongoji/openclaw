        ...
        ${
          state.tab === "chat"
            ? renderChat({
                ...
                moonshineModel: state.moonshineModel,
                moonshineBusy: state.moonshineBusy,
                moonshineRecording: state.moonshineRecording,
                onMoonshineModelChange: (next) => (state.moonshineModel = next),
                onMoonshineTranscribe: () => void state.handleMoonshineTranscribe(),
                onMoonshinePTTStart: () => void state.handleMoonshinePTTStart(),
                onMoonshinePTTStop: () => void state.handleMoonshinePTTStop(),
                onMoonshinePTTCancel: () => void state.handleMoonshinePTTCancel(),
